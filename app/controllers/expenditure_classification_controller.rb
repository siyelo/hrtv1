class ExpenditureClassificationController < ApplicationController
  ...
  def update
    ...
    respond_to do |format|
      if @activity.update_attributes(params[:activity])
        flash[:notice] = "Activity expenditure was successfully updated."
        format.html { redirect_to( activity_expenditure_path(@activity) ) }
        format.xml  { head :ok }
      else
