class Reports::Districts::OrganizationsController < Reports::BaseController
  ...
  def show
    ...
    when "mtef"
      @mtef = true
      if @treemap
        @code_spent_values   = DistrictTreemaps::mtef(@location, activities, 'spent')
        @code_budget_values  = DistrictTreemaps::mtef(@location, activities, 'budget')
      else
      ...
      @nsp = true
      if @treemap
        @code_spent_values   = DistrictTreemaps::nsp(@location, activities, 'spent')
        @code_budget_values  = DistrictTreemaps::nsp(@location, activities, 'budget')
      else
