...
class Reports::ActivityReport
  ...
  def build_header
    ...
    header << [  "activity.budget", "activity.spend", "currency","activity.start", "activity.end", "activity.provider", "activity.provider.FOSAID", "activity.text_for_beneficiaries", "activity.text_for_targets"]
