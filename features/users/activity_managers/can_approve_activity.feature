Feature: Activity Manager can approve a code breakdown for each activity
  ...
  Background:
    Given an organization exists with name: "organization1"
      ...
      And an activity_manager exists with email: "who_manager@hrtapp.com", organization: the organization, current_response: the data_response
      ...
      And an activity_manager exists with email: "activity_manager@hrtapp.com", organization: the organization, current_response: the data_response
