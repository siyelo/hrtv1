Feature: Activity Manager can approve a code breakdown for each activity
  ...
  Background:
    Given an organization exists with name: "organization1"
      ...
      And an activity_manager exists with username: "who_manager", organization: the organization, current_response: the data_response
      ...
      And an activity_manager exists with username: "activity_manager", organization: the organization, current_response: the data_response
