Feature: Activity Manager can see district reports
  ...
  Background:
    Given an organization exists with name: "Organization1"
      ...
      And an activity_manager exists with email: "activity_manager@hrtapp.com", organization: the organization, location: the location
    ...
    When I am signed in as "activity_manager@hrtapp.com"
