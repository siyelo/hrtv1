  ...
  Background:
    ...
    Scenario: Use expenditure by coding for budget by coding (deep coding in same root omitting the parents, using percentages)
      ...
      When I follow "Past Expenditure"
        ...
        And I press "Save"
      Then I should see "We're sorry, when we added up your Current Budget by Purposes classifications, they equaled 240,000.00 but the Past Expenditur is 6,000,000.00 (6,000,000.00 - 240,000.00 = 5,760,000.00, which is ~96.00%). The total classified should add up to 5,000,000.00. Your Current Budget by Purposes classifications must be entered and the total must be equal to the Budget amount."
